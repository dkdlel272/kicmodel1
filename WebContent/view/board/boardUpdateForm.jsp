	...
	<form name="f" action="writePro.jsp" enctype="multipart/form-data"  method="post">
		...
		<div class="form-group">
			...
			<input type="password" class="form-control" name="pass">
			 <label	>제목:</label> <input type="text" class="form-control" name="subject" value="<%=b.getSubject() %>" > 
		</div>
		<div class="form-group">
		<label	>내용</label> 
		...
		<div class="form-group">
			<label >파일저장:</label> 
			<input type="file" class="form-control" name="file1"   value="<%=b.getFile1()%>">
		</div>
